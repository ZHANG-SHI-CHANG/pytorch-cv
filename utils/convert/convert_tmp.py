...
#         gluon_model = ndarray.load(gluon_path)
#     else:
...
#     for key, value in gluon_model.items():
...
#     parse.add_argument('--gluon-path', type=str, default='/home/ace/cbb/own/pretrained/init/default.params',
#                        help='path to the gluon models')
#     parse.add_argument('--torch-path', type=str, default='/home/ace/cbb/own/pretrained',
#                        help='path to the pytorch models')
#     # for detection and segmentation
#     parse.add_argument('--base', action='store_true', default=True, help='use pretrained_base')
