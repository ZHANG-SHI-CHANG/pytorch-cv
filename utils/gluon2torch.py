...
if __name__ == '__main__':
    ...
    parse.add_argument('--name', type=str, default='yolo3_mobilenet1.0_voc', help='name of the model')
    ...
    parse.add_argument('--reorder', type=bool, default=False, help='reorder keys')  # for ssd-resnet
