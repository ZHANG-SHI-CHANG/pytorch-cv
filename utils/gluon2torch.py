...
if __name__ == '__main__':
    ...
    parse.add_argument('--name', type=str, default='ssd_512_mobilenet1.0_voc', help='name of the model')
    ...
    parse.add_argument('--reorder', type=bool, default=True, help='reorder keys')
