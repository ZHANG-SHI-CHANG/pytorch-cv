...
| Model                  | gluon-cv | here (PIL) | here (cv) |
| ---------------------- | -------- | ---------- | --------- |
| CIFAR_ResNet20_v1      | 92.1     | 92.9       | 92.9      |
| CIFAR_ResNet56_v1      | 93.6     | 94.2       | 94.2      |
| CIFAR_ResNet110_v1     | 93.0     | 95.2       | 95.2      |
| CIFAR_ResNet20_v2      | 92.1     | 92.7       | 92.7      |
| CIFAR_ResNet56_v2      | 93.7     | 94.6       | 94.6      |
| CIFAR_ResNet110_v2     | 94.3     | 95.5       | 95.5      |
| CIFAR_WideResNet16_10  | 95.1     | 96.7       | 96.7      |
| CIFAR_WideResNet28_10  | 95.6     | 97.1       | 97.1      |
...
> It's strange to see that "layer=152", the results is worse than gluon-cv
...
| SSD Model                | gluon-cv | here (PIL) | here (cv) |
| ------------------------ | -------- | ---------- | --------- |
| ssd_300_vgg16_atrous_voc | 77.6     | 77.4       | 77.5      |
| ssd_512_vgg16_atrous_voc | 79.2     | 76.2       | 79.1      |
| ssd_512_resnet50_v1_voc  | 80.1     | 78.0       | 80.4      |
| ssd_512_mobilenet1.0_voc | 75.4     | 72.9       | 75.5      |

| YOLO Model                      | gluon-cv | here (PIL) | here (cv) |
| ------------------------------- | -------- | ---------- | --------- |
| yolo3_darknet53_voc (320x320)   | 79.3     | 79.3       | 79.3      |
...
| ---------------------------- | -------- | --------------- |
| faster_rcnn_resnet50_v1b_voc | 78.3     | 78.3            |
...
| COCO Model                           | gluon-cv       | pytorch-cv (v3) |
| ------------------------------------ | -------------- | --------------- |
| faster_rcnn_resnet50_v1b_coco        | 37.0/57.8/39.6 | 37.0/57.8/39.6  |
| faster_rcnn_resnet101_v1d_coco       | 40.1/60.9/43.3 |                 |
| faster_rcnn_fpn_resnet50_v1b_coco    | 38.5/60.1/41.6 |                 |
| faster_rcnn_fpn_resnet101_v1d_coco   | 40.8/62.4/44.7 |                 |
| faster_rcnn_fpn_bn_resnet50_v1b_coco | 39.3/61.3/42.9 |                 |
