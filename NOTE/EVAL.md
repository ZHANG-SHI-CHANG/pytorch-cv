...
| Model                  | Top-1 (gluon-cv) | Top-5 (gluon-cv) | Top-1 (v1) | Top-5 (v1) | Top-5 (v2) | Top-5 (v2) |
| ---------------------- | ---------------- | ---------------- | ---------- | ---------- | ---------- | ---------- |
...
| ResNet101_v1s          |                  |                  |            |            | 80.44      | 95.38      |
| ResNet101_v1s(dilated) |                  |                  |            |            | 80.84      | 95.60      |
...
| ------------------------------------ | -------------- | --------------- |
| faster_rcnn_resnet50_v1b_coco        | 37.0/57.8/39.6 |                 |
