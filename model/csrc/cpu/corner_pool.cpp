...
// 1. bottom pool
std::vector<at::Tensor> bottom_pool_forward(
    at::Tensor input) {
    // Initialize output
...
std::vector<at::Tensor> bottom_pool_backward(
    at::Tensor input, at::Tensor grad_output) {
...
// 2. left pool
std::vector<at::Tensor> left_pool_forward(
    at::Tensor input) {
    // Initialize output
    at::Tensor output = at::zeros_like(input);
...
std::vector<at::Tensor> left_pool_backward(
    at::Tensor input, at::Tensor grad_output) {
    auto output = at::zeros_like(input);
...
// 3. right pool
std::vector<at::Tensor> right_pool_forward(
    at::Tensor input) {
    // Initialize output
    at::Tensor output = at::zeros_like(input);
...
std::vector<at::Tensor> right_pool_backward(
    at::Tensor input, at::Tensor grad_output) {
    at::Tensor output = at::zeros_like(input);
