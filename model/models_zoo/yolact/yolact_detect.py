# TODO
import torch
from model.ops.coder import decode
from model.ops.bbox import bbox_iou_batch
...
class Detect(object):
    ...
    def __init__(self, num_classes, bkg_label, top_k, conf_thresh, nms_thresh,
                 max_num_detections=100, fast_nms=True):
    ...
    def __call__(self, predictions):
        ...
        batch_size, num_priors = loc_data.shape[0], prior_data.shape[0]
    ...
    def fast_nms(self, boxes, masks, scores, iou_threshold=0.5, top_k=200, second_threshold=False):
        ...
        iou = bbox_iou_batch(boxes, boxes)
