...
class RCNN(nn.Module):
    def __init__(self, features, top_features, classes, box_features,
                 short, max_size, train_patterns, nms_thresh, nms_topk, post_nms,
                 roi_mode, roi_size, strides, clip, channel=2048, **kwargs):
        ...
        self.class_predictor = nn.Linear(channel, self.num_class + 1)  # TODO: weight init
        self.box_predictor = nn.Linear(channel, self.num_class * 4)
