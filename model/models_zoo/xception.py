...
# #
# #         self.in_channels = 8
# #         self.conv1 = _make_basic_conv(3, out_channels=self.in_channels,
# #                                       kernel_size=3, stride=2, padding=1)
# #         self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)
# #
# #         self.layer1 = self._make_layer(block, layers[0], channels[0], stride=2)
# #         self.layer2 = self._make_layer(block, layers[1], channels[1], stride=2)
# #         self.layer3 = self._make_layer(block, layers[2], channels[2], stride=2)
# #
# #     def _make_layer(self, block, blocks, mid_out_channels, stride=1):
# #         layers = []
