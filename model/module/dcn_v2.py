...
class _DCNv2(Function):
    ...
    def forward(ctx, input, offset, mask, weight, bias,
        ...
        output = _C.dcn_v2_forward(input, weight, bias,
                                   offset, mask,
    ...
    def backward(ctx, grad_output):
        ...
        grad_input, grad_offset, grad_mask, grad_weight, grad_bias = \
            _C.dcn_v2_backward(input, weight,
                               bias,
                               offset, mask,
                               grad_output,
                               ctx.kernel_size[0], ctx.kernel_size[1],
...
class _DCNv2Pooling(Function):
    ...
    def forward(ctx, input, rois, offset,
        ...
        output, output_count = \
            _C.dcn_v2_psroi_pooling_forward(input, rois, offset,
    ...
    def backward(ctx, grad_output):
        ...
        grad_input, grad_offset = \
            _C.dcn_v2_psroi_pooling_backward(grad_output,
                                             input,
                                             rois,
                                             offset,
                                             output_count,
...
class DCNv2Pooling(nn.Module):
    def __init__(self, spatial_scale, pooled_size, output_dim,
                 no_trans, group_size=1, part_size=None,
...
class DCNPooling(DCNv2Pooling):
    def __init__(self, spatial_scale, pooled_size, output_dim, no_trans,
                 group_size=1, part_size=None, sample_per_part=4,
                 trans_std=.0, deform_fc_dim=1024):
