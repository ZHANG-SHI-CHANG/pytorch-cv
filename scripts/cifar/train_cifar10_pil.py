...
def parse_args():
    ...
    parser.add_argument('-j', '--num-workers', dest='num_workers', default=4, type=int,
    ...
    # others
    parser.add_argument('--data-root', type=str, default=os.path.expanduser('~/.torch/datasets'),
                        help='Default dataset root')
...
class Solver(object):
    ...
    def train(self):
        train_dataset = CIFAR10(root=os.path.join(self.cfg.data_root, 'cifar10'),
