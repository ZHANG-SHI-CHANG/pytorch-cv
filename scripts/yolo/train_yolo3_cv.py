...
def parse_args():
    ...
    # others for yolo TODO: add it
    parser.add_argument('--no_random_shape', action='store_true', default=True,
                        help='whether to use random shape.')
    parser.add_argument('--mixup', action='store_true', default=False,
                        help='whether to enable mixup.')
    parser.add_argument('--no-mixup-epochs', type=int, default=20,
                        help='Disable mixup training if enabled in the last N epochs.')
    parser.add_argument('--label-smooth', action='store_true', default=False, help='Use label smoothing.')
    args = parser.parse_args()
    return args


def get_train_data(dataset, mixup=False):
